 ...
 * @returns {string}
 */
export function result_hash(rows_json) {
    let deferred2_0;
    let deferred2_1;
    try {
 ...
 * @returns {string}
 */
export function verify_disclosure(json) {
    let deferred2_0;
    let deferred2_1;
    try {
 ...
 * @returns {string}
 */
export function verify_receipt(json) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('tattler_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
