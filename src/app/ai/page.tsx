...
const MCPS: McpEntry[] = [
  {
    ...
    author: 'GraphOps',
    category: 'official',
    description: 'Query 15,000+ blockchain subgraphs through natural language, with no GraphQL required. The flagship MCP for The Graph, with a hosted SSE endpoint ready to connect.',
  ...
  },
  {
    ...
    category: 'official',
    description: 'On-chain token data across 9 networks via natural language. ERC-20 & NFT metadata, wallet balances, transfer history, and top holder analysis, with no custom subgraph needed.',
