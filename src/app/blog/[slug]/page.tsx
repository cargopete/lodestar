      ...
      <div className="mt-10 flex flex-col lg:flex-row gap-10">
        ...
        <article
          className="min-w-0 flex-1 prose prose-invert max-w-none
            ...
            prose-code:text-[var(--accent-text)] prose-code:bg-[var(--bg-elevated)] prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-sm prose-code:font-mono
