...
export const PROTOCOLS: ProtocolConfig[] = [
  ...
  },
  {
    ...
    name: 'Curve (Arbitrum)',
    category: 'DEX',
    description: 'Curve stable+crypto AMM on Arbitrum One. Anchored by 2pool/3pool stablecoin liquidity and the wstETH/ETH and frxETH/ETH pools that route LST swap flow on the L2. The largest of the L2 Curve deployments by depth.',
    subgraphId: 'Gv6NJRut2zrm79ef4QHyKAm41YHqaLF392sM3cz9wywc',
  ...
  {
    slug: 'curve-avalanche',
    name: 'Curve (Avalanche)',
    category: 'DEX',
    description: 'Curve stable AMM on Avalanche C-Chain. Smaller deployment than Arbitrum but the canonical stablecoin swap venue on Avalanche, with USDC.e/USDC, av3CRV, and the BTC.b/WBTC.e pool the most active legs.',
    subgraphId: '2Vt8WtdXNZUEeaVtzyEd1dpioJf44nvomzkd4HhubfKS',
    schemaType: 'messari-dex',
    website: 'https://curve.fi',
    chains: ['Avalanche'],
    color: '#73A9DC',
  ...
  },
  {
    ...
    name: 'Curve (Optimism)',
    category: 'DEX',
    description: 'Curve stable AMM on Optimism. Small deployment (sub-$1M TVL) but turns over its float multiple times daily, used primarily as a stable-stable swap rail in OP-ecosystem yield strategies.',
    subgraphId: 'DnfoGy7Rbp7dvWhD4eQZLN62HiCrrZbo2QcHALQeCJ3u',
    schemaType: 'messari-dex',
    website: 'https://curve.fi',
    chains: ['Optimism'],
    color: '#5089C6',
  ...
  },
  {
    ...
    name: 'Curve (Gnosis)',
    category: 'DEX',
    description: 'Curve stable AMM on Gnosis Chain. The dominant stablecoin swap venue on Gnosis, anchored by xDAI/USDC/USDT pools that handle most stable rebalancing on the chain.',
    subgraphId: 'DhPMs3LeVcZ5E5ndBz6AgiWEWfjMTuf2WKhYgEHh1RPr',
    schemaType: 'messari-dex',
    website: 'https://curve.fi',
    chains: ['Gnosis'],
    color: '#04795B',
