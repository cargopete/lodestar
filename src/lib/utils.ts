...
/**
 * Maps secondary payer addresses to their canonical address for display grouping.
 * Both addresses share the same row in the Gateway Breakdown.
 */
export const GATEWAY_CANONICAL: Record<string, string> = {
  '0xb70781305939a39e74aa918416df1b893e1bd904': '0x7d14ae5f20cc2f6421317386aa8e79e8728353d9',
};
