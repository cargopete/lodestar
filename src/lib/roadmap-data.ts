...
export interface RoadmapItem {
  ...
  /** Lodestar's read on actual progress — edit this file to update */
...
export const ROADMAP_ITEMS: RoadmapItem[] = [
  ...
  },
  {
    ...
    description: 'Migration of the Subgraph data service to the Horizon protocol framework. Testnet and mainnet deployment.',
  ...
  },
  {
    ...
    layer: 'protocol',
    title: 'Substreams: P2P Data Service MVP',
  ...
  },
  {
    ...
    description: 'Experimental JSON-RPC data service on The Graph Network — node RPC as a monetised data service.',
    quarterStart: 'Q3 2026',
    officialStatus: 'experimental',
    tags: ['JSON-RPC'],
  },
  ...
  },
  {
    ...
    description: 'Cross-chain GRT liquid staking — GRT holders on multiple chains participating in network economics.',
    quarterStart: 'Q3 2025',
    officialStatus: 'shipped',
    lodestarStatus: 'shipped',
    tags: ['GRT', 'Staking'],
