/**
 * Supabase database types — matches the schema in supabase/migrations/.
 * Regenerate from live DB with: pnpm db:types
 */
...
// Matches the format Supabase CLI generates (pnpm db:types).
// Each table has Row (full), Insert (defaults optional), Update (all optional).
...
export type Database = {
  public: {
    Tables: {
      epochs: {
        Row: EpochRow;
        Insert: Pick<EpochRow, 'id' | 'start_block'> & Partial<Omit<EpochRow, 'id' | 'start_block'>>;
        Update: Partial<EpochRow>;
        Relationships: [];
      };
      network_snapshots: {
        Row: NetworkSnapshotRow;
        Insert: Partial<NetworkSnapshotRow>;
        Update: Partial<NetworkSnapshotRow>;
        Relationships: [];
      };
      indexers: {
        Row: IndexerDbRow;
        Insert: Pick<IndexerDbRow, 'address'> & Partial<Omit<IndexerDbRow, 'address'>>;
        Update: Partial<IndexerDbRow>;
        Relationships: [];
      };
      indexer_snapshots: {
        Row: IndexerSnapshotRow;
        Insert: Pick<IndexerSnapshotRow, 'indexer_address'> & Partial<Omit<IndexerSnapshotRow, 'indexer_address'>>;
        Update: Partial<IndexerSnapshotRow>;
        Relationships: [];
      };
      parameter_changes: {
        Row: ParameterChangeRow;
        Insert: Pick<ParameterChangeRow, 'indexer_address' | 'param_name' | 'new_value'> & Partial<Omit<ParameterChangeRow, 'indexer_address' | 'param_name' | 'new_value'>>;
        Update: Partial<ParameterChangeRow>;
        Relationships: [];
      };
      allocations: {
        Row: AllocationDbRow;
        Insert: Pick<AllocationDbRow, 'id' | 'indexer_address' | 'deployment_id'> & Partial<Omit<AllocationDbRow, 'id' | 'indexer_address' | 'deployment_id'>>;
        Update: Partial<AllocationDbRow>;
        Relationships: [];
      };
      delegation_events: {
        Row: DelegationEventRow;
        Insert: Pick<DelegationEventRow, 'id' | 'event_type' | 'delegator' | 'indexer' | 'tokens_grt'> & Partial<Omit<DelegationEventRow, 'id' | 'event_type' | 'delegator' | 'indexer' | 'tokens_grt'>>;
        Update: Partial<DelegationEventRow>;
        Relationships: [];
      };
      delegator_positions: {
        Row: DelegatorPositionRow;
        Insert: Pick<DelegatorPositionRow, 'delegator' | 'indexer_address'> & Partial<Omit<DelegatorPositionRow, 'delegator' | 'indexer_address'>>;
        Update: Partial<DelegatorPositionRow>;
        Relationships: [];
      };
      subgraph_deployments: {
        Row: SubgraphDeploymentRow;
        Insert: Pick<SubgraphDeploymentRow, 'id' | 'ipfs_hash'> & Partial<Omit<SubgraphDeploymentRow, 'id' | 'ipfs_hash'>>;
        Update: Partial<SubgraphDeploymentRow>;
        Relationships: [];
      };
      curation_signals: {
        Row: CurationSignalRow;
        Insert: Pick<CurationSignalRow, 'id' | 'curator' | 'deployment_id'> & Partial<Omit<CurationSignalRow, 'id' | 'curator' | 'deployment_id'>>;
        Update: Partial<CurationSignalRow>;
        Relationships: [];
      };
      disputes: {
        Row: DisputeRow;
        Insert: Pick<DisputeRow, 'id' | 'indexer_address'> & Partial<Omit<DisputeRow, 'id' | 'indexer_address'>>;
        Update: Partial<DisputeRow>;
        Relationships: [];
      };
      ingestion_state: {
        Row: IngestionStateRow;
        Insert: Pick<IngestionStateRow, 'key'> & Partial<Omit<IngestionStateRow, 'key'>>;
        Update: Partial<IngestionStateRow>;
        Relationships: [];
      };
      blog_posts: {
        Row: BlogPostRow;
        Insert: Pick<BlogPostRow, 'slug' | 'title' | 'content'> & Partial<Omit<BlogPostRow, 'slug' | 'title' | 'content'>>;
