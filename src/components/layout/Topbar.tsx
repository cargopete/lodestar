...
export function Topbar() {
  ...
  return (
    <header className="fixed top-0 left-0 md:left-[var(--sidebar-width)] right-0 h-[var(--topbar-height)] bg-[rgba(12,10,29,0.80)] backdrop-blur-md border-b border-[var(--border)] z-30">
