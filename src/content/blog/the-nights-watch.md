---
title: "Hold the Wall: Announcing The Night's Watch"
date: "2026-06-05"
author: "cargopete"
tags: ["community", "the-graph", "decentralization", "horizon", "data-services", "lodestar"]
category: "News"
excerpt: "I'm one person with a laptop and a Claude Code subscription, and I can't deploy and maintain every data service the network needs on my own. The Night's Watch is an open community for the people who want to — to harden, test, maintain and ultimately run the open data layer The Graph was always supposed to have."
---

> ## ⚔️ Join The Night's Watch
> ### → [discord.gg/484vgDETEZ](https://discord.gg/484vgDETEZ)
> Take the vow. Pick your order. Help hold the wall.
...
Over the last few months I've had my head down building things I genuinely believe matter for the network. A [JSON-RPC data service](/blog/dispatch-json-rpc-horizon). A [Substreams Data Service, community edition](/blog/substreams-data-service-community-edition). A [Solana data service](/blog/seahorn-solana-data-service). [Camp and its data service](/blog/camp-deep-dive). Lodestar itself. A whole [catalogue of what Horizon could be](/data-services).
...
If you've read ["The Indexer Is the Farmer"](/blog/horizon-needs-indexers-to-run-data-services), you already know the shape of the problem: an open marketplace with one supplier isn't a marketplace. The Watch is the answer to that — more hands on the wall.
...
### ⚔️ [discord.gg/484vgDETEZ](https://discord.gg/484vgDETEZ)
